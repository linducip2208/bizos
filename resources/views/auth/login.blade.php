            ...
            <form wire:submit="authenticate" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button
                            type="button"
                            onclick="const field = document.getElementById('fi-login-password'); field.type = field.type === 'password' ? 'text' : 'password'; this.setAttribute('aria-pressed', field.type === 'text'); this.title = field.type === 'text' ? 'Sembunyikan password' : 'Tampilkan password';"

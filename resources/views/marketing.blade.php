...
<head>
    ...
    <meta property="og:image" content="{{ url('/marketing/screens/bizos-hero.png') }}">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ url('/docs') }}" class="text-sm font-medium text-slate-600 hover:text-slate-900 no-underline px-3 py-2 rounded-lg hover:bg-slate-100 transition-colors hidden sm:inline-flex">Dokumentasi</a>
                <a href="{{ url('/admin/login') }}" class="text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 px-4 py-2 rounded-lg transition-colors no-underline shadow-sm">Login</a>
            </div>
        </div>
    </div>
</header>
...
<section class="gradient-hero pt-28 pb-20 sm:pt-36 sm:pb-28 px-4">
    <div class="max-w-4xl mx-auto text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ url('/admin/login') }}" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-indigo-700 font-bold rounded-xl hover:bg-indigo-50 transition-colors shadow-xl shadow-indigo-500/25 text-lg no-underline">
                Coba Demo Gratis
            ...
            <a href="{{ url('/docs') }}" class="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-white/30 text-white font-bold rounded-xl hover:bg-white/10 transition-colors text-lg no-underline">
                Lihat Dokumentasi
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div class="browser-mock">
                ...
                <div class="browser-mock-body"><img src="{{ $screen['url'] }}" alt="{{ $screen['title'] }}" loading="lazy"></div>
            </div>
            @endforeach
        </div>
    </div>
...
<section class="py-20 px-4">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mt-6 text-center">
            <a href="{{ url('/admin/login') }}" class="inline-flex items-center gap-2 px-8 py-4 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200 no-underline">
                Login Admin Panel
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5"><path fill-rule="evenodd" d="M3 4.25A2.25 2.25 0 015.25 2h5.5A2.25 2.25 0 0113 4.25v2a.75.75 0 01-1.5 0v-2a.75.75 0 00-.75-.75h-5.5a.75.75 0 00-.75.75v11.5c0 .414.336.75.75.75h5.5a.75.75 0 00.75-.75v-2a.75.75 0 011.5 0v2A2.25 2.25 0 0110.75 18h-5.5A2.25 2.25 0 013 15.75V4.25z" clip-rule="evenodd"/><path fill-rule="evenodd" d="M6 10a.75.75 0 01.75-.75h9.546l-1.048-.943a.75.75 0 111.004-1.114l2.5 2.25a.75.75 0 010 1.114l-2.5 2.25a.75.75 0 11-1.004-1.114l1.048-.943H6.75A.75.75 0 016 10z" clip-rule="evenodd"/></svg>
            </a>
        </div>
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <a href="{{ url('/admin/login') }}" class="block text-center w-full py-3 border-2 border-indigo-200 text-indigo-700 font-bold rounded-xl hover:bg-indigo-50 transition-colors no-underline">Mulai Gratis</a>
            </div>
            {{-- Growth --}}
            <div class="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl p-8 shadow-xl shadow-indigo-200 text-white transform scale-105 relative">
                ...
                <a href="{{ url('/admin/login') }}" class="block text-center w-full py-3 bg-white text-indigo-700 font-bold rounded-xl hover:bg-indigo-50 transition-colors no-underline">Coba Growth</a>
            </div>
            {{-- Enterprise --}}
            <div class="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-lg transition-shadow">
...
<footer class="bg-slate-900 text-slate-400">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="{{ url('/robots.txt') }}" class="hover:text-white transition-colors no-underline">Robots.txt</a></li>
                </ul>
            </div>
            <div>
        ...
        <div class="border-t border-slate-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
            <div>&copy; {{ date('Y') }} BizOS — Business Operating System. Seluruh hak cipta dilindungi.</div>
            <div class="flex items-center gap-4">
                <a href="{{ url('/sitemap.xml') }}" class="hover:text-white transition-colors no-underline">Sitemap</a>
                <a href="{{ url('/robots.txt') }}" class="hover:text-white transition-colors no-underline">Robots</a>
            </div>
        </div>
    </div>
</footer>

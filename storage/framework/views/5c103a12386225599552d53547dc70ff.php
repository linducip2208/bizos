    ...
    <div class="space-y-6">
        <div class="fi-section rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-800 dark:ring-white/10">
            <div class="text-center py-12">
                ...
                <div class="mt-6">
                    <a href="<?php echo e(url('/admin/integrations')); ?>" class="inline-flex items-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500">
...
<?php endif; ?>
<?php /**PATH D:\project laravel\bizos\resources\views/filament/pages/email-inbox.blade.php ENDPATH**/ ?>
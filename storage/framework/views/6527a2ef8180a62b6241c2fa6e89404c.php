<footer class="bg-slate-900 text-slate-400 mt-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="border-t border-slate-800 mt-10 pt-6 text-center text-xs text-slate-500">
            &copy; <?php echo e(date('Y')); ?> BizOS — Business Operating System. Seluruh hak cipta dilindungi.
        </div>
    </div>
</footer>
<?php /**PATH D:\project laravel\bizos\resources\views/pseo/_footer.blade.php ENDPATH**/ ?>
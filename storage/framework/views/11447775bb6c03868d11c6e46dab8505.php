...
<main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="space-y-6 mb-12">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $comparisons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            <h2 class="text-lg font-bold text-slate-800 mb-4"><?php echo e($loop->iteration); ?>. <?php echo e($c['category']); ?></h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-4 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <p class="text-sm text-green-700 leading-relaxed"><?php echo e($c['bizos']); ?></p>
                </div>
                <div class="p-4 bg-red-50 rounded-lg border border-red-200">
                    ...
                    <p class="text-sm text-red-700 leading-relaxed"><?php echo e($c['spreadsheet']); ?></p>
                </div>
            </div>
        </div>
    ...
    <div class="p-8 bg-gradient-to-br from-indigo-600 via-purple-600 to-violet-700 rounded-2xl text-white shadow-xl">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
            <a href="<?php echo e(url('/docs')); ?>" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-indigo-700 font-bold rounded-xl hover:bg-indigo-50 transition-colors no-underline text-sm">
                Lihat Dokumentasi
            </a>
            <a href="<?php echo e(url('/admin/login')); ?>" class="inline-flex items-center justify-center gap-2 px-6 py-3 border-2 border-white/30 text-white font-bold rounded-xl hover:bg-white/10 transition-colors no-underline text-sm">
                Coba Demo Gratis
            </a>
        </div>
    </div>
...
<?php echo $__env->make('pseo._layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project laravel\bizos\resources\views/pseo/compare-spreadsheet.blade.php ENDPATH**/ ?>
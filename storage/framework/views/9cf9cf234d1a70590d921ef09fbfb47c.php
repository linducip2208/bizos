...
<header class="border-b border-slate-200 bg-white/80 backdrop-blur-lg sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <a href="<?php echo e(url('/admin/login')); ?>" class="text-sm font-medium text-indigo-600 hover:text-indigo-700 no-underline px-4 py-2 rounded-lg hover:bg-indigo-50 transition-colors">
                Login Admin
            </a>
        </div>
    </div>
...
<nav class="sticky top-16 z-40 bg-white border-b border-slate-200 overflow-x-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex gap-1 py-2 text-sm font-medium whitespace-nowrap">
            ...
            <a href="#fitur-<?php echo e(\Illuminate\Support\Str::slug($f['group'])); ?>" class="px-2.5 py-1.5 rounded-md hover:bg-indigo-50 text-slate-500 hover:text-indigo-700 transition-colors no-underline text-xs"><?php echo e($f['group']); ?></a>
...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-20">
    ...
    <section id="demo-accounts">
        ...
        <div class="overflow-x-auto rounded-xl border border-slate-200 shadow-sm">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $demoAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="hover:bg-slate-50/80 transition-colors">
                        <td class="px-5 py-3 font-semibold text-slate-800"><?php echo e($account['role']); ?></td>
                        <td class="px-5 py-3"><code class="text-xs bg-slate-100 px-2 py-1 rounded font-mono"><?php echo e($account['email']); ?></code></td>
                        <td class="px-5 py-3"><code class="text-xs bg-slate-100 px-2 py-1 rounded font-mono"><?php echo e($account['password']); ?></code></td>
                        <td class="px-5 py-3 text-slate-600 text-xs leading-relaxed max-w-xs"><?php echo e($account['scope']); ?></td>
                    </tr>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </tbody>
            </table>
        ...
        <div class="mt-4 text-center">
            <a href="<?php echo e(url('/admin/login')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 transition-colors shadow-md shadow-indigo-200 no-underline text-sm">
    ...
    <section id="struktur-menu">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $menuStructure; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm hover:shadow-md transition-shadow">
                <h3 class="font-bold text-slate-800 mb-3 text-sm uppercase tracking-wider text-indigo-600"><?php echo e($group); ?></h3>
            ...
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-4 bg-white rounded-xl border border-slate-200 p-5 shadow-sm hover:shadow-md transition-shadow">
                        <div class="flex-shrink-0 w-10 h-10 bg-indigo-600 text-white rounded-full flex items-center justify-center font-bold text-sm"><?php echo e($step['step']); ?></div>
                        <div>
                            <h4 class="font-bold text-slate-800 mb-1"><?php echo e($step['title']); ?></h4>
                            <p class="text-sm text-slate-600 leading-relaxed"><?php echo e($step['desc']); ?></p>
                        </div>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
    ...
    <section id="fitur">
        ...
        <div class="space-y-14">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $groupedFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div id="fitur-<?php echo e(\Illuminate\Support\Str::slug($group)); ?>">
                <h3 class="text-xl font-bold text-indigo-700 mb-5 pb-2 border-b-2 border-indigo-100 sticky top-[calc(4rem+4rem)] bg-white/95 backdrop-blur-sm z-30 py-2"><?php echo e($group); ?> <span class="text-sm font-normal text-slate-400">(<?php echo e(count($items)); ?> menu)</span></h3>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                        <div class="bg-gray-100 dark:bg-gray-700 px-3 py-2 flex items-center gap-2 border-b border-gray-200 dark:border-gray-600">
                            ...
                            <div class="flex-1 min-w-0 mx-auto bg-white dark:bg-gray-600 rounded-full px-3 py-0.5 text-[10px] text-gray-400 dark:text-gray-300 font-mono text-center truncate"><?php echo e(\Illuminate\Support\Str::slug($f['title'])); ?>.bizos.id</div>
                        </div>
                        <div class="aspect-[16/10] bg-gray-50 dark:bg-gray-900 overflow-hidden">
                            <img src="<?php echo e(url('/marketing/screens/' . $f['screenshot'])); ?>" alt="<?php echo e($f['title']); ?> - BizOS" class="w-full h-full object-contain">
                        </div>
                        <div class="p-4">
                            <h4 class="font-semibold text-gray-900 dark:text-white text-sm"><?php echo e($f['title']); ?></h4>
                            <p class="text-gray-500 dark:text-gray-400 text-xs mt-1 leading-relaxed"><?php echo e($f['description']); ?></p>
                        </div>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
    ...
    <section id="cta" class="bg-gradient-to-br from-indigo-600 via-purple-600 to-violet-700 rounded-2xl p-10 sm:p-14 text-center text-white shadow-xl shadow-indigo-200/50">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(url('/admin/login')); ?>" class="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-white text-indigo-700 font-bold rounded-xl hover:bg-indigo-50 transition-colors shadow-lg no-underline">
                Login Admin Panel
            ...
            <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center justify-center gap-2 px-8 py-3.5 border-2 border-white/30 text-white font-bold rounded-xl hover:bg-white/10 transition-colors no-underline">
                Kembali ke Beranda
            </a>
        </div>
    </section>
...
<?php echo $__env->make('pseo._layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project laravel\bizos\resources\views/pseo/docs-index.blade.php ENDPATH**/ ?>
...
class WorkCenterResource extends Resource
{
    ...
    {
        return \App\Filament\Resources\WorkCenterResource\Schemas\WorkCenterForm::configure($schema);
    }

    public static function table(Table $table): Table
    {
        return \App\Filament\Resources\WorkCenterResource\Tables\WorkCenterTable::configure($table);
    }

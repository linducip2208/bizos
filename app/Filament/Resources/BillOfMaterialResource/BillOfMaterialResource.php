...
class BillOfMaterialResource extends Resource
{
    ...
    {
        return \App\Filament\Resources\BillOfMaterialResource\Schemas\BillOfMaterialForm::configure($schema);
    }

    public static function table(Table $table): Table
    {
        return \App\Filament\Resources\BillOfMaterialResource\Tables\BillOfMaterialTable::configure($table);
    }

...
use App\Filament\Resources\WasteLogResource\Pages;
...
class WasteLogResource extends Resource
{
    ...
    {
        return \App\Filament\Resources\WasteLogResource\Schemas\WasteLogForm::configure($schema);
    }

    public static function table(Table $table): Table
    {
        return \App\Filament\Resources\WasteLogResource\Tables\WasteLogTable::configure($table);
    }

...
namespace App\Filament\Resources\ProductionQcChecks;

use App\Filament\Resources\ProductionQcChecks\Pages;
...
class ProductionQcCheckResource extends Resource
{
    ...
    {
        return \App\Filament\Resources\ProductionQcChecks\Schemas\ProductionQcCheckForm::configure($schema);
    }

    public static function table(Table $table): Table
    {
        return \App\Filament\Resources\ProductionQcChecks\Tables\ProductionQcCheckTable::configure($table);
    }

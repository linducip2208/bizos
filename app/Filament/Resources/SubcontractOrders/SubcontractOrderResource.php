...
namespace App\Filament\Resources\SubcontractOrders;

use App\Filament\Resources\SubcontractOrders\Pages;
...
class SubcontractOrderResource extends Resource
{
    ...
    {
        return \App\Filament\Resources\SubcontractOrders\Schemas\SubcontractOrderForm::configure($schema);
    }

    public static function table(Table $table): Table
    {
        return \App\Filament\Resources\SubcontractOrders\Tables\SubcontractOrderTable::configure($table);
    }

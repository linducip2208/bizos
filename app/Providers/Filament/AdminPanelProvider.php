    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->navigationGroups([
                ...
                NavigationGroup::make('Alat Hitung')->collapsed(true),
                ...
                NavigationGroup::make('Kesehatan')->collapsed(true),
                NavigationGroup::make('Konstruksi')->collapsed(true),
                ...
                NavigationGroup::make('Field Service')->collapsed(true),
                NavigationGroup::make('ESG')->collapsed(true),
                NavigationGroup::make('Kepatuhan')->collapsed(true),
                NavigationGroup::make('Gamifikasi')->collapsed(true),
                NavigationGroup::make('IoT & Sensor')->collapsed(true),
                NavigationGroup::make('Treasury')->collapsed(true),

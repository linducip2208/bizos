...
class DocsController extends Controller
{
    ...
    protected function demoAccounts(): array
    {
        return [
            ...
            [
                'role' => 'Admin Finance',
                'email' => 'ahmad@maju.test',
                'password' => 'password',
                'scope' => 'COA, jurnal, invoice, pembayaran, pajak, budget, aset, laporan keuangan',
            ],
            [
                'role' => 'Manager Sales',
                'email' => 'andi@maju.test',
                'password' => 'password',
                'scope' => 'CRM leads & deals, WA blast, pipeline, laporan penjualan, target sales',
            ],
            [
                'role' => 'Manager IT',
                'email' => 'donni@maju.test',
                'password' => 'password',
                'scope' => 'Project, task, timesheet, sprint, milestone, anggota tim',
            ],
            [
                'role' => 'Staff',
                'email' => 'dewi@maju.test',
                'password' => 'password',
                'scope' => 'Absensi, cuti, lembur, reimbursement, task, timesheet, chat, LMS',
            ],
            [
                'role' => 'Staff',
                'email' => 'rudi@maju.test',
                'password' => 'password',
                'scope' => 'Absensi, cuti, lembur, reimbursement, task, timesheet, chat, LMS',
            ],
            [
                'role' => 'Kasir',
                'email' => 'fitriani@maju.test',
                'password' => 'password',

...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('closing_periods')) {
        ...
        if (!Schema::hasTable('opening_balances')) {
            Schema::create('opening_balances', function (Blueprint $table) {
                ...
                $table->unique(['company_id', 'coa_id', 'period_year', 'period_month'], 'opening_balances_ukey');
            });
        }
        ...
        if (!Schema::hasTable('trial_balances')) {
            Schema::create('trial_balances', function (Blueprint $table) {
                ...
                $table->unique(['company_id', 'coa_id', 'period_year', 'period_month'], 'trial_balances_ukey');
            });
        }
        ...
        if (!Schema::hasTable('financial_consolidations')) {
